...
class Mdl_installment extends CI_Model {
    ...
    function _get_data_from_db_print_voucher($where) {
        $this->db->select('installment.id std_voucher_id,installment.std_name std_name,installment.std_id std_id,installment.fee total,installment.due_date due_date,voucher_data.tution_fee tution_fee,voucher_data.lunch_fee lunch_fee,voucher_data.transport_fee transport_fee,users.org_name org_name');
