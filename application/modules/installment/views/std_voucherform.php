    ...
    <div class="content-wrapper">
      <h3>
        ...
        if (empty($update_id)) 
                    ...
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'installment/std_voucher/'.$voucher_id.'/'.$class;?>"><button type="button" class="btn btn-lg btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a>
       </h3>             
