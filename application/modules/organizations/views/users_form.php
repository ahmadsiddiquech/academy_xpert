    ...
    <div class="content-wrapper">
      <h3> 
          <?php if (empty($update_id)) 
                 ...
                 ?>
                            <a href="<?php echo ADMIN_BASE_URL . 'Organizations'; ?>"><button type="button" class="btn btn-lg btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a> 
        </h3>
