...
<div class="content-wrapper">
    <h3>Announcement<a href="announcement/create"><button type="button" class="btn btn-primary btn-lg pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;<b>Add Announcement</b></button></a></h3>
