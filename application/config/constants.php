...
if($_SERVER['HTTP_HOST'] == 'ds-pc' || $_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == '192.168.100.13'){
	// ************** FOR LOCAL SERVER
	define('BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/');
	define('HTTPS_BASE_URL', 'https://'.$_SERVER['HTTP_HOST'].'/academy/');
	define('BASE_URL_NEWS_LISTING', 'http://'.$_SERVER['HTTP_HOST'].'/academy/front/');
	define('FOOTER_BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/template/');
	define('IMAGE_BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/uploads/');
	define('CAPTCHA_BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/captcha/');
	define('ADMIN_BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/admin/');
	define('STATIC_ADMIN_CSS', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/admin/theme1/css/');
	define('STATIC_ADMIN_JS', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/admin/theme1/js/');
	define('STATIC_ADMIN_IMAGE', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/admin/theme1/images/');
	///////////////////FRONT///////////////////////////////
	define('STATIC_FRONT_CSS', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/front/academy/css/');
	define('STATIC_FRONT_JS', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/front/academy/js/');
	define('STATIC_FRONT_IMAGE', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/front/academy/images/');
}
else{
	// ************** FOR LIVE SERVER
	define('BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/academy/');
	...
	define('STATIC_FRONT_JS', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/front/academy/js/');
	define('STATIC_FRONT_IMAGE', 'http://'.$_SERVER['HTTP_HOST'].'/academy/static/front/academy/images/');
	define('STATIC_FRONT_NOTIFICATION', '../academy/static/front/academy/notification/');
	...
	// define('STATIC_FRONT_CSS', 'http://'.$_SERVER['HTTP_HOST'].'/static/front/academy/css/');
	// define('STATIC_FRONT_JS', 'http://'.$_SERVER['HTTP_HOST'].'/static/front/academy/js/');
	// define('STATIC_FRONT_IMAGE', 'http://'.$_SERVER['HTTP_HOST'].'/static/front/academy/images/');
}
...
define('MEDIUM_ADDPOST_IMAGE_PATH', 'http://localhost/academy/uploads/add_post/medium_images/');
